...
namespace NerdStore.BDD.Tests.Pedido
{
    public class PedidoTela : PageObjectModel
    {
        ...
        {
            return Convert.ToDecimal(Helper.ObterTextoElementoPorId("valorUnitario").Replace("R$", " ").Trim());
        }

        public decimal ObterValorTotalCarrinho()
        {
            return Convert.ToDecimal(Helper.ObterTextoElementoPorId("valorTotalCarrinho").Replace("R$", " ").Trim());
        }
        ...
        {
            Helper.ObterElementoPorXPath("/html/body/header/nav/div/div/ul/li[3]/a/span").Click();
        }
        ...
        public void ZerarCarrinhoDeCompras()
        {
            ...
            {
                var botao = Helper.ObterElementoPorXPath("/html/body/div/main/div/div/div/table/tbody/tr[1]/td[5]/form/button");
                botao.Click();
            }
        }
    }
